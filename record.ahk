...
; 請依需求增加或修改
Run %ComSpec% /k "streamlink www.youtube.com/watch?v=RkgHSqdMCCI 720p -o %start_time%_ebc.ts"
Run %ComSpec% /k "streamlink www.youtube.com/watch?v=4ZVUmEUFwaY 720p -o %start_time%_setn.ts"
Run %ComSpec% /k "streamlink bcsecurelivehls-i.akamaihd.net/hls/live/510713/4862438529001/indexTVBS-N-HD-CH1-M.m3u8 best -o %start_time%_tvbs.ts"
